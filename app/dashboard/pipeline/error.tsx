...
export default function PipelineError({
  ...
  useEffect(() => {
    console.error("[PipelineError]", error);
  }, [error]);

  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="flex items-center justify-center h-14 w-14 rounded-2xl bg-slate-100 mb-4">
        <Kanban className="h-7 w-7 text-slate-400" />
      </div>
      <h2 className="text-base font-semibold text-slate-800 mb-1">Erro ao carregar o Pipeline</h2>
