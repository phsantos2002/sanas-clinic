...
export default function WorkflowsError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-base font-semibold text-slate-800 mb-1">Erro ao carregar Workflows</h2>
      <p className="text-sm text-slate-500 mb-5 max-w-xs">
        Não foi possível carregar os fluxos de automação. Tente novamente.
      </p>
      <button
        onClick={reset}
