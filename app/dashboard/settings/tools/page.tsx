...
import { Plus, Repeat, Clock, MessageCircle, Mail } from "lucide-react";
  ...
  return (
    <div className="space-y-5 max-w-5xl">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-slate-900">Cadências</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {cadences.map((c) => {
            ...
            return (
              <Link
                key={c.id}
                href={`/dashboard/settings/tools/cadencias/${c.id}`}
