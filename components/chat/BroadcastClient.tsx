                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${statusCfg.color}`}
                      >
                        {statusCfg.label}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-[10px] text-slate-400">
                      ...
                      {bc.sentCount > 0 && (
                        <span className="text-green-600">{bc.sentCount} enviadas</span>
                      )}
                      {bc.failedCount > 0 && (
                        <span className="text-red-500">{bc.failedCount} falhas</span>
                      )}
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {bc.status === "draft" && (
                      <button
                        onClick={() => handleExecute(bc.id)}
                        disabled={executing === bc.id}
