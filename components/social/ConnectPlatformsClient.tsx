...
import { saveSocialConnection, disconnectPlatform } from "@/app/actions/social";
...
const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    color: "text-red-600",
    bgColor: "bg-red-600",
    description: "Pins e boards visuais",
    available: false,
  },
  {
    id: "google_business",
...
export function ConnectPlatformsClient({
  ...
  const handleSaveConnection = async () => {
    ...
    const result = await saveSocialConnection({
      ...
      profileName: connectModal.platform.name,
    });
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4 shadow-2xl">
            ...
            <div className="flex gap-3 mt-5">
              <button
                ...
                className="flex-1 py-2 px-4 border border-slate-200 text-slate-600 rounded-xl text-sm font-medium hover:bg-slate-50 transition-colors"
              >
                Cancelar
              </button>
              <button
