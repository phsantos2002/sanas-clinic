...
export function InstagramBrand({ className }: BrandIconProps) {
  return (
...
export function FacebookBrand({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden>
...
export function YouTubeBrand({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden>
...
export function TikTokBrand({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden>
      <path
...
export function LinkedInBrand({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden>
...
export function GoogleBrand({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden>
      <path
...
export const PLATFORM_LOGOS: Record<string, ComponentType<BrandIconProps>> = {
  instagram: InstagramBrand,
  facebook: FacebookBrand,
  youtube: YouTubeBrand,
  tiktok: TikTokBrand,
  linkedin: LinkedInBrand,
  google_business: GoogleBrand,
};
